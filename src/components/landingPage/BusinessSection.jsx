...
export default function BusinessSection() {
  ...
  const businesses = [
  {
    ...
    description: "In 2019, Jagdamba Trailers has swiftly established itself as a prominent and trustworthy brand within the Indian Trailer Industry. We manufacture a wide array of trailer types, including flatbed trailers, tanker trailers, and specialized transport solutions.",
  ...
  },
  {
    ...
    description: "Jagdamba Structurals Pvt. Ltd is a highly diversified, fastest growing company in fabrication, erection of Steel Structure, equipment, PEB & Building Projects. The range of products we manufacture and provide to our customers includes parts for industrial equipment.",
  ...
  },
  {
    ...
    description: "Nestled in serene surroundings, LÃ Fountain resort offers a perfect blend of luxury and tranquility, designed to provide an unforgettable experience for our guests. At LÃ Fountain Resort, we pride ourselves on delivering top-notch hospitality, exceptional service, and a range of amenities tailored to meet the diverse needs of our visitors. Whether you're seeking a relaxing getaway, a family vacation, or a venue for special events, our resort is the ideal destination.",
  ...
  },
  {
    ...
    description: "Swapan Engineering Co. is Jagdamba Group’s latest venture, established in Kolkata to strengthen our footprint in the railway sector. Specializing in the manufacturing of railway electrical equipment, this new plant brings precision, quality, and innovation to components that power India’s rail infrastructure. With Swapan Engineering, we aim to drive forward reliable and future-ready rail solutions.",
  ...
  return (
    <div className="w-full bg-[#F5F5F5]">
      <section className="container relative w-full bg-[#F5F5F5] px-6 md:px-10 xl:px-25 py-16 md:py-24 overflow-hidden mx-auto max-w-7xl">
        ...
        {/* Faint Base Line (Optional: Ensures the line never completely disappears in the gaps) */}
          ...
          {businesses.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {/* --- THE GRADIENT TIMELINE UPDATE --- */}
                {/* Gradient Line Segment: Max opacity at the center, fading to transparent top and bottom */}
                ...
                <div className={`w-full md:w-1/2 md:pr-12 lg:pr-20 flex md:justify-end transition-all duration-700 ease-out relative z-10
                ...
                `}>
                  {isEven ? (
                    ...
                    <div className="w-full max-w-[454px] text-left pt-6 md:pt-2">
                ...
                <div className={`w-full md:w-1/2 mt-8 md:mt-0 md:pl-12 lg:pl-20 flex md:justify-start transition-all duration-700 ease-out delay-150 relative z-10
                  ${shown ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}
                `}>
                  {isEven ? (
                    <div className="w-full max-w-[454px] text-left pt-6 md:pt-2">
