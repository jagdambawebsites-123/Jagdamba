    ...
    <div className="min-h-screen bg-[#111C55] font-libre text-white overflow-hidden relative">
      ...
      <main className="relative z-10 px-8 md:px-20 pt-24 md:pt-32 lg:pt-40 pb-12 md:pb-20">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 items-start">
          {/* Header & Description */}
          <div className="lg:w-[38%] animate-slide-left lg:pl-12">
            <h1 className="font-baskerville mb-6 md:mb-10 leading-[1.24] tracking-normal whitespace-nowrap text-[30px] sm:text-[40px] md:text-[50px] font-normal">
              Awards & <span className="text-[#FFB800] font-baskerville">Recognition</span>
            </h1>
            <div className="space-y-6 md:space-y-10 text-white/80 text-[18px] md:text-[22px] leading-[1.6] font-light max-w-none tracking-wide">
              <p>
              ...
              <p>
                ...
                communities. They represent the collective effort of our
                teams, our commitment to delivering meaningful outcomes,
                and our continuous pursuit of setting higher standards across
                industries.
              </p>
            </div>
          </div>
          ...
          <div className="lg:w-fit w-full relative animate-slide-right lg:-mt-4 ml-auto flex flex-col items-center">
            ...
            {/* Navigation Dots for Mobile - shows all 3 */}
            ...
            {/* Navigation Arrows - Desktop Only Aligned */}
            <div className="hidden md:flex justify-end gap-5 mt-4 w-full md:w-[calc(380px*2+24px)]">
              <button
                onClick={prevSlide}
                className="w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-white flex items-center justify-center transition-all hover:scale-110 active:scale-95 group shadow-lg"
      ...
      <section className="relative -mt-8 md:-mt-14 bg-[#111C55] md:bg-transparent">
        {/* Staggered Background Transition - Desktop Only */}
        <div className="absolute inset-0 -z-10 hidden md:flex overflow-hidden">
          {/* First left part: slightly dimmer (light gray) and ends earlier */}
          <div className="w-[44%] h-full bg-[#f2f4f7]"></div>
          {/* Second right half: blue extends lower before switching to white */}
          <div className="w-[56%] h-full relative">
            {/* The blue background extends lower on this side */}
        ...
        <div className="px-8 md:px-20 flex flex-col lg:flex-row items-center lg:items-end justify-between gap-16 md:gap-12 relative z-10 pt-10 lg:pt-0">
          ...
          <div className="w-full max-w-[90%] md:max-w-3xl min-h-[60px] bg-white rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.15)] py-12 px-8 md:py-20 md:px-20 relative border border-gray-100 flex flex-col justify-center items-center md:ml-10 z-20 mb-12 md:mb-20 order-2 lg:order-1 mt-10 lg:mt-0">
            ...
            <div className="absolute top-4 left-4 md:top-4 md:left-4">
              <Image
                src="/images/aboutPage/about-awards/Quotes left.png"
                alt="Opening Quote"
                width={60}
                height={45}
            ...
            <div className="absolute bottom-4 right-4 md:bottom-4 md:right-4">
              <Image
                src="/images/aboutPage/about-awards/Quotes right.png"
                alt="Closing Quote"
                width={60}
                height={45}
                className="w-10 h-auto md:w-20"
        ...
        {/* Half White / Half Blue Bottom Border - Desktop Only */}
      ...
      {/* Second White Blank Page - Our Presence */}
      <section className="w-full min-h-screen bg-white relative overflow-hidden py-24 lg:pt-12 lg:pb-32">
        ...
        {/* Vector 12 - Right Side (matching Vector1 pattern) */}
        <div className="absolute top-80 right-[1%] w-[95%] h-[70%] z-0 opacity-100 pointer-events-none">
          <Image
            src="/images/aboutPage/about-awards/Vector 12.png"
            alt=""
            fill
            className="object-contain object-right-top"
          />
        ...
        {/* Vector 13 - Left Side (matching Vector2 pattern) */}
        <div className="absolute top-[320px] left-[4%] w-[50%] h-[25%] z-0 opacity-100 pointer-events-none">
          <Image
            src="/images/aboutPage/about-awards/Vector 13.png"
            alt=""
            fill
            className="object-contain"
          />
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-20 relative z-10">
          <div className="flex flex-col lg:grid lg:grid-cols-[45%_55%] items-center lg:items-center justify-between gap-12 lg:gap-4 mt-8 lg:mt-0">
            {/* Left Content: Header & Grid */}
            {/* 1. Heading and Paragraph (Order 1) */}
            <div className="w-full flex flex-col items-start order-1 lg:-translate-x-32 lg:pt-32">
              <h2 className="font-baskerville font-normal text-[#111C55] mb-4 md:mb-6 text-[32px] md:text-[52px] leading-[1.1]">
                Our <span className="text-[#CA9015]">Presence</span>
              </h2>
              <p className="font-libre font-normal text-[#6B7280] mb-8 md:mb-12 text-[15px] md:text-[18px] leading-[22px] md:leading-[26px] max-w-xl">
                We delivered projects around 198 location in 18 states, in <br /> India making a global impact with our work.
              </p>
            </div>

            {/* 3. City Cards Grid (Order 3 on mobile, Column 1 on desktop) */}
            <div className="w-full flex flex-col items-start order-3 lg:-translate-x-32 lg:col-start-1">
              <div className="grid grid-cols-2 gap-4 md:gap-6 w-full max-w-5xl">
                ...
                <div className="bg-[#111C55] rounded-2xl p-5 lg:p-6 flex items-center gap-5 shadow-[0_10px_30px_rgba(5,11,44,0.15)] border border-white/5 transition-transform hover:scale-105 duration-300">
                  <div className="w-10 h-10 md:w-12 md:h-12 relative shrink-0">
                    <Image src="/images/aboutPage/about-awards/bangalore.png" alt="Banglore Icon" fill className="object-contain brightness-0 invert" />
                  </div>
                  <span className="text-xs md:text-lg font-semibold tracking-[0.1em] text-white uppercase font-playfair">Banglore</span>
                </div>
              </div>
            </div>

            {/* 2. India Map (Order 2 on mobile, Column 2 on desktop) */}
            <div className="w-full flex justify-center lg:justify-end items-center order-2 lg:col-start-2 lg:row-span-2 mt-8 lg:mt-0 relative">
              <div className="relative w-full max-w-[360px] md:max-w-[700px] aspect-[4/5] md:aspect-square lg:scale-[1.18] lg:translate-x-12 lg:translate-y-20 translate-y-0 transition-all duration-1000">
                <Image
